...
func (r *TicketRepository) GetMany(_ context.Context) ([]*models.Ticket, error) {
...
func (r *TicketRepository) GetOne(_ context.Context, ticketId uint) (*models.Ticket, error) {
